...
import { BACKEND_API } from "@/lib/http/api";
...
type FormErrorsType = Partial<Record<keyof FormValuesType, string[]>>;
...
const SigninPage = () => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    const response = await fetch(`${BACKEND_API}/auth/users/login/initiate`, {
      method: "POST",
