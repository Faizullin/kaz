                            ...
                            {farmers.length > 0 ? farmers.map((invoice) => (
                                    <TableRow key={invoice?.id}>
                                        ...
                                        <TableCell>
                                            <HoverCard>
                                                <HoverCardTrigger asChild>
                                                    <TypographyP
                                                        className="underline cursor-pointer">{invoice?.fullname}</TypographyP>
                                                </HoverCardTrigger>
                                                <HoverCardContent className="w-80">
                                                    <div className="flex flex-col gap-2">
                                                        <TypographyP className="!m-0 !p-0">Full
                                                            name: {invoice?.fullname}</TypographyP>
                                                        <TypographyP
                                                            className="!m-0 !p-0">Email: {invoice?.email}</TypographyP>
                                                        <TypographyP
                                                            className="!m-0 !p-0">Phone: {invoice?.phone}</TypographyP>
                                                        <TypographyP
                                                            className="!m-0 !p-0">Role: {invoice?.role}</TypographyP>
                                                    </div>
                                                </HoverCardContent>
                                            </HoverCard>
                                        </TableCell>
                                        ...
                                        <TableCell className="w-full flex flex-col items-center">
                                            <Switch id="is_approved"
                                                    onCheckedChange={(checked) => handleChange(checked, invoice.id)}
                                                    checked={invoice.profile?.is_approved}/>
                                        </TableCell>
                                        <TableCell>
                                            <Edit className="cursor-pointer" size={24}
                                                  onClick={() => setEditingUser(invoice)}/>
                                        </TableCell>
                                        <TableCell>
                                            <Trash2 className="cursor-pointer" size={24} stroke="red"
                                ...
                                <TableRow><TableCell></TableCell><TableCell><TypographyP>No
                                    farmers</TypographyP></TableCell></TableRow>}
                        </TableBody>
                    </Table>
                </TabsContent>
                    ...
                    <Table className="w-full m-auto">
                        ...
                        <TableBody>
                            {buyers.length > 0 ? buyers.map((invoice) => (
                                ...
                                :
                                <TableRow><TableCell></TableCell><TableCell><TypographyP>No
                                    buyers</TypographyP></TableCell></TableRow>
                            }
                        </TableBody>
                    </Table>
                </TabsContent>
